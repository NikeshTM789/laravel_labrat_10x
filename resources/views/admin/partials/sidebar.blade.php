  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ settings('logo') ? asset(settings('logo')) : asset('assets/img/default_logo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">{{ settings(\App\Enums\SettingEnum::APP->value) ?? 'LARAVEL10X' }}</span>
    </a>
